"""Generate an artifact inventory; file presence is not scientific validation."""
...
def main():
    entries = {
        "Segmentation MoNuSeg": "reports/segmentation_evaluation/summary.json",
        "Classification cellulaire": "reports/cell_gnn_comparison/results.json",
        "XAI cellulaire sur modèles gelés": "reports/cell_xai/summary.json",
        "Occlusion des clusters de patches": "reports/candidate_cluster_audit/summary.json",
        "Audit des frontières de patches": "reports/cluster_structure_audit/summary.json",
    }
    lines = [
        "# Statut GCIA",
        "",
    ...
    (ROOT / "reports/status_artifact_hashes.json").write_text(json.dumps(hashes, indent=2))
